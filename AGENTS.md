...
- **Linting & Formatting:** Ensure code adheres to Go conventions using golangci-lint. You **MUST** use golangci-lint. Other tools such as `go fmt` or `go vet` are insufficient.
